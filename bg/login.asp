...
<title><%=setting.siteTitle%>世界蓝莓小姐大赛网站管理平台</title>
<style type="text/css">
<!--
*{
	padding:0px;
...
.main .login .butbox dl dt{
	height:50px;
	padding-top:5px;
	background-image: url(images/logo_user.jpg);
	background-repeat: no-repeat;
}
...
<body>
	...
	<div class="main">
		...
		<form method="post" action="?action=login" onsubmit="writeCookie('username',this.username.value, 1)">
            ...
            <dl>
					<dt></dt>
			  <dd>
                    <span style="color:#505050;font-size:12px;display:block">世界蓝莓小姐大赛组委会欢迎您！ </span>
                   
               <a href="/">返回首页</a><!-- | <a href="http://www.chancoo.com">上谷网络</a> | <a href="http://kaiyuan.chancoo.com">开源创新实验室</a>			   --></dd>
			  </dl>
			</div>
		</form>
	...
	<div class="copyright">
		MISS INTERNATIONAL  BLUEBERRY  PAGEANT
	</div>
