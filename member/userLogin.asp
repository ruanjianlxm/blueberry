...
document.write("        </tr>");
document.write("        <tr>");
document.write("          <td height=\"24\">验证码：</td>");
...
document.write("              <input type=\"button\" value=\"注册\" style=\"BORDER: #B7DAEF 1px solid;color:#0099ff\" onclick=\"location.href=\'<%=sitepath%>/member/reg.asp\'\" /></td>");
document.write("        </tr>");
document.write("    </table>");
document.write("      </form>");
<%	else%>
