...
hidden = "<p><a href='javascript:void(0)' onClick=""window.open('checkout.asp?act=print')"">打印订单</a></p>"
...
Dim total:total=0
result=""
result = result & "<table width='100%' border='0' cellspacing='1' cellpadding='0' bgcolor='#000000'>"
result = result & "<tr bgcolor='#FFFFFF' align='center'>"
result = result & "<td bgcolor='#FFFFFF'>商品图片</td>"
result = result & "<td bgcolor='#FFFFFF'>商品名称</td>"
result = result & "<td bgcolor='#FFFFFF'>单价</td>"
result = result & "<td bgcolor='#FFFFFF'>数量</td>"
result = result & "</tr>"
...
Set dic = Session("Cart")
	For Each md In dic
		...
		Set rs = GetRS(sql)	
result = result & "<tr bgcolor='#FFFFFF' align='center'>"
result = result & "<td bgcolor='#FFFFFF'><a title='点击查看原图' href='../content/?"&rs("contentid")&".html'  target=_blank><img src='"&rs("IndexImage")&"' width='70' height='50' /></a></td>"
result = result & "<td bgcolor='#FFFFFF'><a title='"&rs("title")&"' href='../content/?"&rs("contentid")&".html'  target=_blank>"&rs("title")&"</a></td>"
result = result & "<td bgcolor='#FFFFFF'><span id='price"&md&"'>"&rs("P_Price")&"</span>元</td>"
result = result & "<td bgcolor='#FFFFFF'>"&dic(md)&"</td>"
result = result & "</tr>"
...
hidden = hidden & "<a href='javascript:void(0)' onClick=""window.open('checkout.asp?act=print')"">打印订单</a>    <input type='submit' value='确认订单' name='btnSubmit'/></p></form>"
