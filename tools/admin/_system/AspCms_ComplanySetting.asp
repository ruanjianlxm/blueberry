...
<TBODY>
    ...
    <TR class=list>
        ...
        <TD>        
        <textarea class="textarea" name="StatisticalCode" cols="60" style="width:80%" rows="3"><%=decode(StatisticalCode)%></textarea> <img src="../images/help.gif" class="tTip" title="第三方统计代码<br>调用标签：{aspcms:companypostcode}">
		</TD>
    </TR>
    <TR class=list>
        <TD><STRONG>版权信息 : </STRONG></TD>
        <TD>
        <textarea class="textarea" name="CopyRight" cols="60" style="width:80%" rows="3"><%=decode(CopyRight)%></textarea> <img src="../images/help.gif" class="tTip" title="版权信息<br>调用标签：{aspcms:copyright}">
         </TD>
    </TR>
    <TR class=list>
