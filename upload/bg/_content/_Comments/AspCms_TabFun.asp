...
dim sql, msg
	...
	Else
		Do while not rsObj.Eof 
		 ...
		 echo "<input type=""checkbox"" name=""TabField"" value=""'"&rsObj("TabCategory")&"_"&rsObj("TabField")&"'"" style=""display:none"" />"
		 ...
		 echo "<td>"&rsObj("TabCategory")&"_"&rsObj("TabField")&"</td>" 
		 else
...
Dim sql,tmp
	...
	'die m_TabField
	tmp = m_TabField
	if TabCategory <> "" then tmp = TabCategory & "_" & m_TabField
