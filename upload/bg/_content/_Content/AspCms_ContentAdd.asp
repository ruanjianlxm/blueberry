...
<TABLE cellSpacing=0 cellPadding=2 width="100%" align=center border=0>
  ...
  <TR>
    ...
    <TD><%LoadSelect "SortID","Aspcms_Sort","SortName","SortID",0,0," and( sortid in(select ParentID from {prefix}Sort where 1=1 and SortType="&sortType&" order by SortOrder) or SortType="&sortType&")","请选择分类"%></TD>
    <TD>标题颜色</TD>
...
专属为只有设定的该组可以访问"></TD>
  ...
  <TR>
    ...
    <TD><input class="input" value="<%=now%>" onClick="WdatePicker()" style="WIDTH: 120px" name="AddTime"/></TD>
    <TD>排序 </TD>
