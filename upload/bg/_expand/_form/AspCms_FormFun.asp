...
dim sql, msg
	...
	Else
		Do while not rsObj.Eof 
		 ...
		 echo "<input type=""checkbox"" name=""FormField"" value=""'"&rsObj("FormCategory")&"_"&rsObj("FormField")&"'"" style=""display:none"" />"
...
Dim sql,tmp
	...
	'die m_FormField
	tmp = m_FormField
	if FormCategory <> "" then tmp = FormCategory & "_" & m_FormField
