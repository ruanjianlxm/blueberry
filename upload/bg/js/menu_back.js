...
function OpenMenu(cid,lurl,rurl,bid){
   if($Nav()=='IE'){
   	 if(top.document.frames.menu.document.body.outerHTML.indexOf("ASPCMS!")==-1)
	 {
	 ...
	 if(top.document.getElementById("menu").contentWindow.document.body.innerHTML.indexOf("ASPCMS!")==-1)
	 {
	 	alert("Powered by AspCms!");
